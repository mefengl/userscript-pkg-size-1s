...
(() => {
  ...
  function createButtonNPM(packageName) {
    ...
    if (newElement) {
      createButton(newElement, `https://pkg-size.dev/${packageName}`, "", { backgroundColor: '#FFF5DE', color: '#FF7251', borderColor: '#FF7251' }, `${svgIcon} <strong>Check</strong> Package Size`);
    }
  }
